...
<head>
    ...
    <title>Informazioni PHP - ERICA BONALUMI</title>
    <style>
        body {
...
<body>
    <div class='header'>
        ...
        <p>Configurazione del server PHP per ERICA BONALUMI</p>
    </div>
    
    <div class='info-box'>
        <h2>📊 Dati Studente</h2>
        <p><strong>Nome:</strong> ERICA BONALUMI</p>
        <p><strong>Classe:</strong> 4CINF</p>
        <p><strong>Username:</strong> bonalumi.erica</p>
